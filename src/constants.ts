...
export const ACTION_COMBAT_GRAND_BANOXNID = ACTION_COMBAT_BASE + 7
export const ACTION_COMBAT_GRAND_ARCANE_DRAGON = ACTION_COMBAT_BASE + 8
export const ACTION_COMBAT_GRAND_SNAPPER_BUG = ACTION_COMBAT_BASE + 9
export const ACTION_COMBAT_GRAND_SNUFFLEQUARG = ACTION_COMBAT_BASE + 10
export const ACTION_COMBAT_GRAND_OBGORA = ACTION_COMBAT_BASE + 11
export const ACTION_COMBAT_GRAND_LOSSUTH = ACTION_COMBAT_BASE + 12
export const ACTION_COMBAT_GRAND_SQUIGGLE_EGG = ACTION_COMBAT_BASE + 13
export const ACTION_COMBAT_GRAND_QUARTZ_EAGLE = ACTION_COMBAT_BASE + 14
export const ACTION_COMBAT_GRAND_DWELLER_BAT = ACTION_COMBAT_BASE + 15
export const ACTION_COMBAT_GRAND_ANCIENT_ENT = ACTION_COMBAT_BASE + 16
export const ACTION_COMBAT_GRAND_ROCKHAWK = ACTION_COMBAT_BASE + 17
export const ACTION_COMBAT_GRAND_QRAKUR = ACTION_COMBAT_BASE + 18
export const ACTION_COMBAT_GRAND_ELEMENTAL_DRAGON = ACTION_COMBAT_BASE + 19
export const ACTION_COMBAT_GRAND_ERKAD = ACTION_COMBAT_BASE + 20
...
// Attack
export const ACTIONCHOICE_ATTACK_BASE = 1500
export const ACTIONCHOICE_ATTACK_MONSTER = ACTIONCHOICE_ATTACK_BASE
export const ACTIONCHOICE_ATTACK_MAX = 1999

// Magic
export const ACTIONCHOICE_MAGIC_BASE = 2000
export const ACTIONCHOICE_MAGIC_SHADOW_BLAST = ACTIONCHOICE_MAGIC_BASE
export const ACTIONCHOICE_MAGIC_NATURES_FURU = ACTIONCHOICE_MAGIC_BASE + 1
