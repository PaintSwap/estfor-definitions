...
export const AZURITE_COWL = HEAD_BASE + 16
...
export const AZURITE_BODY = BODY_BASE + 16
...
export const AZURITE_BRACERS = ARMS_BASE + 16
...
export const AZURITE_CHAPS = LEGS_BASE + 16
...
export const AZURITE_BOOTS = FEET_BASE + 16
...
export const ADAMANITE_ARROW = ARROW_BASE + 3
...
export const ADAMANITE_ARROW_HEAD = MISC_BASE - 45
...
export const ACTION_ALCHEMY_ITEM = ACTION_FLETCHING_BASE
...
export const ACTIONCHOICE_SMITHING_ADAMANITE_ARROW_HEAD = ACTIONCHOICE_SMITHING_BASE + 59
...
export const ACTIONCHOICE_CRAFTING_AZURITE_COWL = ACTIONCHOICE_CRAFTING_BASE + 73
export const ACTIONCHOICE_CRAFTING_AZURITE_BODY = ACTIONCHOICE_CRAFTING_BASE + 74
export const ACTIONCHOICE_CRAFTING_AZURITE_CHAPS = ACTIONCHOICE_CRAFTING_BASE + 75
export const ACTIONCHOICE_CRAFTING_AZURITE_BRACERS = ACTIONCHOICE_CRAFTING_BASE + 76
export const ACTIONCHOICE_CRAFTING_AZURITE_BOOTS = ACTIONCHOICE_CRAFTING_BASE + 77
...
export const ACTIONCHOICE_RANGED_BRONZE_ARROW = ACTIONCHOICE_RANGED_BASE
export const ACTIONCHOICE_RANGED_IRON_ARROW = ACTIONCHOICE_RANGED_BASE + 1
export const ACTIONCHOICE_RANGED_MITHRIL_ARROW = ACTIONCHOICE_RANGED_BASE + 2
export const ACTIONCHOICE_RANGED_ADAMANTIE_ARROW = ACTIONCHOICE_RANGED_BASE + 3
export const ACTIONCHOICE_RANGED_RUNITE_ARROW = ACTIONCHOICE_RANGED_BASE + 4
export const ACTIONCHOICE_RANGED_TITANIUM_ARROW = ACTIONCHOICE_RANGED_BASE + 5
export const ACTIONCHOICE_RANGED_ORICHALCUM_ARROW = ACTIONCHOICE_RANGED_BASE + 6
export const ACTIONCHOICE_RANGED_BRONZE_DART = ACTIONCHOICE_RANGED_BASE + 7
export const ACTIONCHOICE_RANGED_MAX = 3499

// Fletching
export const ACTIONCHOICE_FLETCHING_BASE = 3999
...
export const ACTIONCHOICE_FLETCHING_ADAMANITE_ARROW = ACTIONCHOICE_FLETCHING_BASE + 12
...
export const ACTIONCHOICE_FLETCHING_MAX = 3499
