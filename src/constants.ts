...
export const ACTIONCHOICE_RANGE_BRONZE_ARROW = ACTIONCHOICE_RANGED_BASE
export const ACTIONCHOICE_RANGE_IRON_ARROW = ACTIONCHOICE_RANGED_BASE + 1
export const ACTIONCHOICE_RANGE_MITHRIL_ARROW = ACTIONCHOICE_RANGED_BASE + 2
export const ACTIONCHOICE_RANGE_ADAMANTIE_ARROW = ACTIONCHOICE_RANGED_BASE + 3
export const ACTIONCHOICE_RANGE_RUNITE_ARROW = ACTIONCHOICE_RANGED_BASE + 4
export const ACTIONCHOICE_RANGE_TITANIUM_ARROW = ACTIONCHOICE_RANGED_BASE + 5
export const ACTIONCHOICE_RANGE_ORICHALCUM_ARROW = ACTIONCHOICE_RANGED_BASE + 6
export const ACTIONCHOICE_RANGE_BRONZE_DART = ACTIONCHOICE_RANGED_BASE + 7
export const ACTIONCHOICE_RANGE_MAX = 3499
